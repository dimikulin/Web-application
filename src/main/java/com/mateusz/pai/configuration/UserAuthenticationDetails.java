 ...
 */
package com.mateusz.pai.configuration;

import com.mateusz.pai.dao.userDao; 
...
public class UserAuthenticationDetails implements UserDetailsService { 
    ...
    public UserDetails loadUserByUsername(String login)  
        ...
        if (user != null) {             
            ...
            return new 
             org.springframework.security.core.userdetails.User(user.getLogin(),  user.getPassword(), true, true, true, true, grupa);         
        } else {             
